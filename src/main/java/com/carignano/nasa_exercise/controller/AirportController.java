...
public class AirportController {
    ...
    public ResponseEntity<NasaAwcResponse<List<StationInfo>>> getClosestStations(@PathVariable @NotNull String airportId, @RequestParam(required = false) Double closestBy){
